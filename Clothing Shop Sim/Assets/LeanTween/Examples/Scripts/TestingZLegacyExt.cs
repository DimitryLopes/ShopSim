...
public class TestingZLegacyExt : MonoBehaviour {
    ...
    void cycleThroughExamples()
    {
        if (exampleIter == 0)
        {
            ...
            Time.timeScale = useEstimatedTime ? 0 : 1f; // pause the Time Scale to show the effectiveness of the useEstimatedTime feature (this is very usefull with Pause ScreenType)
